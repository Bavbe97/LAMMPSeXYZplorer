...
class Test_XYZWriter_write_to_xyz(unittest.TestCase):
    ...
    def test_write_to_xyz(self):
        ...
        step = {'natoms' : 10, 'keywords': ['id', 'type', 'mass', 'element', 'x', 'y', 'z',
                                             'vx', 'vy', 'vz', 'fx', 'fy', 'fz'], 
                    'data': [[1, 2, 12, 'H2', 0.3, 0.31, 0.4, 5, 
                              0.6, 77, -88.8, 'test', 0],
                                [2, 3, 16, 'C3', 0.3, 0.31, 0.4, 5, 
                              0.6, 77, -88.8, 'test', 0],
                                [3, 0, 32, 'N', 0.3, 0.31, 0.4, 5, 
                              0.6, 77, -88.8, 'test', 0]]
                         }
        with out as out:
    ...
    def test_no_data(self):
        ...
        file_path = os.path.join(os.getcwd(), 'xyz', filename)
        out = XYZWriter(file_path)
        step = {'natoms' : 10, 'keywords': ['id', 'type', 'mass', 'element', 'x', 'y', 'z', 'vx', 'vy', 'vz', 'fx', 'fy', 'fz']}
    ...
    def test_no_element_coordinates(self):
        ...
        file_path = os.path.join(os.getcwd(), 'xyz', filename)
        out = XYZWriter(file_path)
        step = {'natoms' : 10, 'keywords': ['id', 'type', 'mass', 'vx', 'vy', 'vz', 'fx', 'fy', 'fz'], 
    ...
    def test_thermo_data_no_box(self):
        ...
        step = {'natoms' : 10, 'thermo': 
                                {'keywords': ['Step', 'Time', 'c_temp', 'v_vel',
                                              'v_force', 'test'], 
                                 'data': [0, 1, 6, -11.3, 999, 'test']},
                'keywords': ['id', 'type', 'mass', 'element', 'x', 'y', 'z', 'vx',
                             'vy', 'vz', 'fx', 'fy', 'fz'],
                'data': [[1, 2, 12, 'H2', 0.3, 0.31, 0.4, 5, 
                              0.6, 77, -88.8, 'test', 0],
                                [2, 3, 16, 'C3', 0.3, 0.31, 0.4, 5, 
        ...
        with open(file_path, 'r') as file:
            content = file.readlines()
        self.assertIn('10\n', content)
        self.assertIn('Step=0; Time=1; temp=6; vel=-11.3; force=999; test=test\n', content)
        self.assertIn('H2 0.3 0.31 0.4 5 0.6 77 -88.8 test 0 2\n', content)
        self.assertIn('C3 0.3 0.31 0.4 5 0.6 77 -88.8 test 0 3\n', content)
        self.assertIn('N 0.3 0.31 0.4 5 0.6 77 -88.8 test 0 0\n', content)
        self.created_files.append(os.path.join(os.getcwd(), 'xyz', filename))
    ...
    def test_thermo_data_yes_box(self):
        ...
        with open(file_path, 'r') as file:
            content = file.readlines()
        self.assertIn('10\n', content)
        self.assertIn('Step=0; Time=1; Box=[0, 5], [0, 0], [4.7, -9]; temp=6; vel=-11.3; force=999; test=test\n', content)
        self.assertIn('H2 0.3 0.31 0.4 5 0.6 77 -88.8 test 0 2\n', content)
        self.assertIn('C3 0.3 0.31 0.4 5 0.6 77 -88.8 test 0 3\n', content)
        self.assertIn('N 0.3 0.31 0.4 5 0.6 77 -88.8 test 0 0\n', content)
        self.created_files.append(os.path.join(os.getcwd(), 'xyz', filename))
