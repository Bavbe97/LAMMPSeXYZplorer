...
def convert_value(value):
    ...
    converted_elements: list
        ...
        converted to a list of elements.
            Elements in the list are converted to integers, floats, or remain
            as strings based on their content.
    value: str
...
def read_yaml(file, step):
    """Reads lines from a file and processes YAML-like formatted data,
    generated as an OUTPUT of a LAMMPS calculation.
